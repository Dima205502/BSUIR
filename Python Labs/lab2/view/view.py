...
class View:
    ...
    def create_start_window(self):
        ...
        add_to_xml_button.grid(row=1, column=0, padx=10, pady=20)
        get_from_xml_button.grid(row=1, column=1, padx=10, pady=20)
        show_tree_button.grid(row=1, column=2, padx=10, pady=20)
